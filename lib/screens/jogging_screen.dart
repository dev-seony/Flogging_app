  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Jogging Record', style: TextStyle(color: Colors.black)),
        centerTitle: true,
      ),
      body: Column(
        children: [
          Container(
            ...
            child: const Center(
              child: Text('Google Map\n(조깅 경로 표시)', textAlign: TextAlign.center, style: TextStyle(color: Colors.grey)),
            ),
          ),
          Padding(
